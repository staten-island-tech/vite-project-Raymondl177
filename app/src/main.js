...
const quizzes = [
  ...
  },
  {
    ...
    category: "Math",
    filter: "All",
    img: "/src/images/medium-math.webp"
  },
  {
    name: "Hard Math Quiz",
    difficulty: "Hard",
  ...
  },
  {
    ...
    category: "Animal",
    filter: "All",
    img: "/src/images/easy-animal.webp"
  },
  {
    ...
    category: "Animal",
    filter: "All",
    img: "/src/images/medium-animal.webp"
  },
  {
    ...
    category: "Animal",
    filter: "All",
    img: "/src/images/hard-animal.webp"
  },
  {
    ...
    category: "Science",
    filter: "All",
    img: "/src/images/easy-science.webp"
  },
  {
    ...
    category: "Science",
    filter: "All",
    img: "/src/images/medium-science.webp"
  },
  {
    ...
    category: "Science",
    filter: "All",
    img: "/src/images/hard-science.jpg"
  },
  {
    ...
    category: "Geography",
    filter: "All",
    img: "/src/images/easy-geography.webp"
  },
  {
    ...
    category: "Geography",
    filter: "All",
    img: "/src/images/medium-geography.webp"
  },
  {
    ...
    category: "Geography",
    filter: "All",
    img: "/src/images/hard-geography.webp"
  }
];
...
const questionBank = {
  ...
  "Easy Animal Quiz": [
    ...
    { q: "What animal has a trunk?", a: ["Elephant", "Giraffe", "Lion", "Tiger"] },
    { q: "What animal has feathers?", a: ["Bird", "Dog", "Cat", "Fish"] },
    { q: "What animal lays eggs?", a: ["Chicken", "Dog", "Cat", "Cow"] }
  ],

  "Medium Animal Quiz": [
    { q: "What animal is a mammal?", a: ["Dolphin", "Shark", "Crocodile", "Eagle"] },
    { q: "What animal hibernates?", a: ["Bear", "Dog", "Cat", "Elephant"] },
    { q: "What animal has gills?", a: ["Fish", "Dog", "Cat", "Horse"] },
    { q: "What animal lives in herds?", a: ["Elephant", "Tiger", "Fox", "Wolf"] },
    { q: "What animal migrates in winter?", a: ["Bird", "Cat", "Dog", "Lion"] }
  ],

  "Hard Animal Quiz": [
    { q: "What animal uses echolocation?", a: ["Bat", "Lion", "Dog", "Elephant"] },
    { q: "What animal is the fastest bird?", a: ["Peregrine Falcon", "Eagle", "Ostrich", "Sparrow"] },
    { q: "What animal has the strongest bite?", a: ["Crocodile", "Lion", "Tiger", "Shark"] },
    { q: "What animal is a monotreme?", a: ["Platypus", "Kangaroo", "Dog", "Cat"] },
    { q: "What animal is an apex predator?", a: ["Great White Shark", "Rabbit", "Deer", "Frog"] }
  ],

  "Easy Science Quiz": [
    { q: "Water freezes at what temperature?", a: ["0°C", "100°C", "50°C", "32°C"] },
    { q: "What gas do plants breathe in?", a: ["Carbon dioxide", "Oxygen", "Nitrogen", "Hydrogen"] },
    { q: "What planet is closest to the sun?", a: ["Mercury", "Earth", "Venus", "Mars"] },
    { q: "What force pulls objects down?", a: ["Gravity", "Magnetism", "Friction", "Electricity"] },
    { q: "What organ pumps blood?", a: ["Heart", "Lungs", "Brain", "Liver"] }
  ],

  "Medium Science Quiz": [
    { q: "What is the chemical symbol for oxygen?", a: ["O", "Ox", "O2", "C"] },
    { q: "What part of the cell holds DNA?", a: ["Nucleus", "Ribosome", "Mitochondria", "Cytoplasm"] },
    { q: "What simple machine is a ramp?", a: ["Inclined plane", "Lever", "Pulley", "Wheel"] },
    { q: "What type of energy is stored energy?", a: ["Potential energy", "Kinetic", "Thermal", "Chemical"] },
    { q: "What organ controls the body?", a: ["Brain", "Heart", "Liver", "Stomach"] }
  ],

  "Hard Science Quiz": [
    { q: "State Newton’s third law.", a: ["Every action has an equal and opposite reaction", "Force equals mass times acceleration", "Objects in motion stay in motion", "Energy cannot be created"] },
    { q: "What subatomic particle has no charge?", a: ["Neutron", "Proton", "Electron", "Photon"] },
    { q: "Define osmosis.", a: ["Movement of water through a membrane", "Movement of air", "Chemical reaction", "Energy transfer"] },
    { q: "What is the powerhouse of the cell?", a: ["Mitochondria", "Nucleus", "Ribosome", "Golgi apparatus"] },
    { q: "What wave requires a medium?", a: ["Sound wave", "Light wave", "Radio wave", "X-ray"] }
  ],

  "Easy Geography Quiz": [
    { q: "What is the largest ocean?", a: ["Pacific Ocean", "Atlantic Ocean", "Indian Ocean", "Arctic Ocean"] },
    { q: "What continent is Egypt in?", a: ["Africa", "Asia", "Europe", "South America"] },
    { q: "What country is Rome in?", a: ["Italy", "France", "Spain", "Greece"] },
    { q: "What is the capital of Japan?", a: ["Tokyo", "Kyoto", "Osaka", "Hiroshima"] },
    { q: "What river runs through Egypt?", a: ["Nile", "Amazon", "Yangtze", "Mississippi"] }
  ],

  "Medium Geography Quiz": [
    { q: "What continent has the most countries?", a: ["Africa", "Asia", "Europe", "South America"] },
    { q: "What mountain range is in South America?", a: ["Andes", "Himalayas", "Rockies", "Alps"] },
    { q: "What is the capital of Australia?", a: ["Canberra", "Sydney", "Melbourne", "Brisbane"] },
    { q: "What ocean borders the east United States?", a: ["Atlantic Ocean", "Pacific Ocean", "Indian Ocean", "Arctic Ocean"] },
    { q: "What country is north of the United States?", a: ["Canada", "Mexico", "Russia", "Greenland"] }
  ],

  "Hard Geography Quiz": [
    { q: "What is the longest river in the world?", a: ["Nile", "Amazon", "Yangtze", "Mississippi"] },
    { q: "Name the highest mountain on Earth.", a: ["Mount Everest", "K2", "Kangchenjunga", "Lhotse"] },
    { q: "What line separates hemispheres east and west?", a: ["Prime Meridian", "Equator", "Tropic of Cancer", "Tropic of Capricorn"] },
    { q: "Name the driest desert in the world.", a: ["Atacama", "Sahara", "Gobi", "Kalahari"] },
    { q: "What country has the most time zones?", a: ["France", "USA", "Russia", "China"] }
  ]
};
...
function loadQuestions () {
  ...
  const answerButtons = quizContent.querySelectorAll(".answer");
      answerButtons.forEach((btn) => {
        btn.addEventListener("click", () => {
          ...
          answerDiv.querySelectorAll(".answer").forEach((b) => b.classList.remove("selected"));
  ...
  submitButton.onclick = () => {
    let score = 0;
    questions.forEach((item, index) => {
    const questionBlock = quizContent.querySelector(`.question-block[data-index="${index}"]`);
    const answers = questionBlock.querySelectorAll(".answer");
    const selectedAnswer = questionBlock.querySelector(".answer.selected");
